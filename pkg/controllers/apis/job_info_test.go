			...
			pod: &v1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					...
					Annotations: map[string]string{
						vcbatchv1.TaskSpecKey: taskName,
						vcbatchv1.JobVersion:  "1",
					},
				},
			},
			expectRes: true,
		...
		},
		{
			...
			pod: &v1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					Name:        podName,
					Namespace:   namespace,
					Annotations: map[string]string{vcbatchv1.JobVersion: "1"},
				},
			},
			expectRes: false,
		},
		{
			...
			pod: &v1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					Name:        podName,
					Namespace:   namespace,
					Annotations: map[string]string{vcbatchv1.TaskSpecKey: taskName},
				},
			},
			expectRes: false,
		},
		{
			...
			pod: &v1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					...
					Namespace: namespace,
					Annotations: map[string]string{
						vcbatchv1.TaskSpecKey: "otherTask",
						vcbatchv1.JobVersion:  "1",
					},
				},
			},
